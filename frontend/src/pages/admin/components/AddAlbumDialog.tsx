			...
			<DialogContent className='bg-zinc-900 border-zinc-700 max-h-[80vh] overflow-auto'>
				...
				<div className='space-y-4 py-4'>
					...
					<div className='space-y-2'>
						<label className='text-sm font-medium select-none'>Album Title</label>
						<Input
					...
					<div className='space-y-2'>
						{/* TODO: change to album description */}
					...
					<div className='space-y-2'>
						<label className='text-sm font-medium select-none'>Release Year</label>
						<Input
							type='number'
