...
// TODO: dialog might be obselete if saving songs from search
const AddSongDialog = () => {
	...
	return (
		...
		<DialogContent className='bg-zinc-900 border-zinc-700 max-h-[80vh] overflow-auto'>
			...
			<div className='space-y-4 py-4'>
				...
				<div className='space-y-2'>
					<label className='text-sm font-medium select-none'>Artist</label>
					<Input
				...
				<div className='space-y-2'>
					<label className='text-sm font-medium select-none'>Duration (seconds)</label>
					<Input
						type='number'
						min='0'
				...
				<div className='space-y-2'>
					<label className='text-sm font-medium select-none'>Album (Optional)</label>
					<Select
