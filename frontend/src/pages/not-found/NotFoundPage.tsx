		...
		<div className='h-full bg-neutral-900 flex items-center justify-center'>
			<div className='text-center space-y-8 px-4'>
				...
				<div className='flex justify-center animate-bounce'>
					<Music2 className='h-16 w-16 sm:h-24 sm:w-24 text-emerald-500' />
				</div>

				{/* Error message */}
				<div className='space-y-4'>
					<h1 className='sm:text-7xl font-bold text-white'>404</h1>
					<h2 className='sm:text-2xl font-semibold text-white'>Page not found</h2>
