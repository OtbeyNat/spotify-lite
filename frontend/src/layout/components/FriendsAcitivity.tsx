...
const FriendsAcitivity = () => {
    ...
    // TODO: OPTIONAL - search and add friend?

    return (
        <div className='h-full bg-zinc-900 rounded-lg flex flex-col'>
            <div className="p-4 flex justify-between items-center border-b border-zinc-800 select-none">
                            ...
                            <div key={user._id} className="cursor-pointer hover:bg-zinc-800/50 p-3 rounded-md transition-colors group">
                                <div className="flex items-start gap-3">
                                    <div className="relative">
                                        <Avatar className="size-10 border border-zinc-800 select-none">
                                            <AvatarImage 
                                                src={user.imageUrl}
                                                alt={user.fullName}
                                            />
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            <span className="font-medium text-sm gap-2 text-white">{user.fullName}</span>
